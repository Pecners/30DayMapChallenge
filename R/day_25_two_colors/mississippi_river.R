...
outfile <- "plots/day_25/miss_pop.png"
...
annot <- glue("This map shows population density within ten miles ",
              "of the Mississippi River. Population estimates are bucketed ",
              "into 400 meter hexagons.") |> 
  str_wrap(35)


img |> 
  image_crop(geometry = "5000x5500+0+0", gravity = "center") |> 
  image_annotate(text = "Mississippi River", gravity = "northeast",
  ...
  image_annotate(text = annot, gravity = "northwest",
                 location = "+200+2500", font = "El Messiri",
  ...
  image_composite(image_modulate(f_image, brightness = 60, saturation = 60) |> 
                  ...
                  gravity = "south", 
                  offset = "-1500+1000") |> 
  image_write("plots/day_25/titled_miss_pop.png")
