...
ggsave("plots/day_3/inset.png")


inset <- image_read("plots/day_3/inset.png")

scaled_inset <- image_scale(inset, "50%")

img <- image_read("plots/day_3/upheaval_dome_pink_greens_z14.png")
...
img |> 
  ...
  image_composite(scaled_inset, gravity = "north", 
                  offset = "-1600+1250") |> 
  image_write("plots/day_3/titled_upheaval_dome.png")
